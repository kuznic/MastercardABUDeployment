...
declare @SQL varchar(max) = N'create  procedure abu_populate_pc_cards_abu_N  @numOfRecords int, @bankBin char(6), @recordsCount int out
as
...
SELECT top (@numOfRecords) PERCENT
